...
public interface IAuthService
{
    ...
    public Task RevokeRefreshToken(RefreshToken token, string ipAddress, string reason); // Bir refresh token'ı geçersiz kılar
    ...
    public Task<RefreshToken> RotateRefreshToken(RefreshToken token, string ipAddress); // Önceki refresh token'ı geçersiz kılıcak (revoke) aktifliği yeni refresh token'a vericek.
